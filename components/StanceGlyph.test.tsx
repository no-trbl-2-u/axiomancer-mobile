...
describe('StanceGlyph dispatcher', () => {
    ...
    it('routes kind="body" to GlyphBody (placeholder still in place)', () => {
...
describe('GlyphBody / GlyphMind (placeholders, untouched by this swap)', () => {
    it('GlyphBody still renders (no regression)', () => {
