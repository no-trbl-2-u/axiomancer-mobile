...
import type { GatherToolId } from '@/state/gathering/types';
...
const styles = StyleSheet.create({
    ...
    topStripMid: { fontFamily: FONTS.mono, fontSize: 8, color: AXM.bone, letterSpacing: 2 },
    scene: {
    ...
    boardNote: { fontFamily: FONTS.serifItalic, fontStyle: 'italic', fontSize: 11, color: AXM.bone, marginTop: 2 },
    ...
    depthCellText: { fontFamily: FONTS.sans, fontSize: 7.5, letterSpacing: 0.8, color: AXM.bone },
    sceneFooter: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 5, alignItems: 'baseline' },
    bagCount: { fontFamily: FONTS.mono, fontSize: 8, color: AXM.bone, letterSpacing: 0.4 },
    duskNote: { fontFamily: FONTS.sans, fontSize: 8, letterSpacing: 1, color: AXM.sulfur },
    ...
    boonName: { fontFamily: FONTS.sans, fontSize: 8, letterSpacing: 0.8 },
    boonReward: { fontFamily: FONTS.mono, fontSize: 7, color: AXM.bone, letterSpacing: 0 },
    boonDesc: { fontFamily: FONTS.serif, fontSize: 9, color: AXM.bone },
    sectionLabel: {
    ...
    takeButtonText: { fontFamily: FONTS.gothic, fontSize: 12, letterSpacing: 2, color: '#86a821' },
    aidsRow: { flexDirection: 'row', gap: 8, paddingHorizontal: 12, marginTop: 10 },
    aidsLabel: { fontFamily: FONTS.sans, fontSize: 8, letterSpacing: 1.6, color: AXM.bone },
    offeringChip: {
        flexDirection: 'row',
        alignItems: 'center',
        gap: 6,
    ...
    offeringName: { fontFamily: FONTS.sans, fontSize: 8.5, letterSpacing: 0.8, color: AXM.parchment },
    offeringDemand: { fontFamily: FONTS.mono, fontSize: 8, color: AXM.bone },
    toolChip: {
        flexDirection: 'row',
        alignItems: 'center',
        gap: 6,
    ...
    toolName: { fontFamily: FONTS.sans, fontSize: 8.5, letterSpacing: 0.8, color: AXM.parchment },
    toolDesc: { fontFamily: FONTS.mono, fontSize: 8, color: AXM.bone },
    ctaRow: {
        flexDirection: 'row',
        gap: 8,
        paddingHorizontal: 12,
    ...
    ctaSub: { fontFamily: FONTS.mono, fontSize: 7.5, letterSpacing: 1, color: AXM.bone, marginTop: 1 },
});
