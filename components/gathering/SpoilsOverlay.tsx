...
const styles = StyleSheet.create({
    ...
    topStripText: { fontFamily: FONTS.sans, fontSize: 10, letterSpacing: 2.5, color: AXM.parchment },
    sectionLabel: { fontFamily: FONTS.sans, fontSize: 9, letterSpacing: 1.6, color: AXM.bone, textAlign: 'center', marginTop: 14, marginBottom: 6 },
    emptyNote: { fontFamily: FONTS.serifItalic, fontStyle: 'italic', fontSize: 12, color: AXM.bone, textAlign: 'center', paddingVertical: 8 },
    ...
    stackName: { flex: 1, fontFamily: FONTS.serif, fontSize: 12, color: AXM.parchment },
    ...
    familyCellText: { fontFamily: FONTS.mono, fontSize: 8 },
    setBadge: { fontFamily: FONTS.sans, fontSize: 7, letterSpacing: 1.4, color: '#0c0a08', paddingHorizontal: 5, overflow: 'hidden' },
    ...
    refinedDesc: { fontFamily: FONTS.serifItalic, fontStyle: 'italic', fontSize: 11, color: AXM.bone, marginTop: 2 },
    roundHarvest: { fontFamily: FONTS.sans, fontSize: 9, letterSpacing: 1, color: '#86a821', textAlign: 'center', marginTop: 8 },
    ...
    ledgerNote: { fontFamily: FONTS.mono, fontSize: 10, letterSpacing: 0.4 },
    ...
    boonName: { fontFamily: FONTS.sans, fontSize: 9, letterSpacing: 1 },
    boonDesc: { fontFamily: FONTS.serif, fontSize: 10, color: AXM.bone },
    boonReward: { fontFamily: FONTS.mono, fontSize: 8 },
