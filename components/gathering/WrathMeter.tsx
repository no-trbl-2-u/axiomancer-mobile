...
const styles = StyleSheet.create({
    ...
    label: { fontFamily: FONTS.sans, fontSize: 9, letterSpacing: 1.6, color: AXM.bone },
    value: { fontFamily: FONTS.gothic, fontSize: 14 },
    max: { fontFamily: FONTS.mono, fontSize: 9, color: AXM.bone },
    ...
    graceNote: { fontFamily: FONTS.mono, fontSize: 8, letterSpacing: 0.5, color: GRACE_ACCENT },
});
