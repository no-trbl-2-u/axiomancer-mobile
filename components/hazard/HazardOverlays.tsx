...
const styles = StyleSheet.create({
    ...
    rollBadge: { fontFamily: FONTS.sans, fontSize: 12, letterSpacing: 2, color: AXM.bg, paddingHorizontal: 12, paddingVertical: 3, overflow: 'hidden' },
    rollTitle: { fontFamily: FONTS.gothic, fontSize: 26, color: AXM.parchment, letterSpacing: 1, marginTop: 14 },
    rollSub: { fontFamily: FONTS.serifItalic, fontStyle: 'italic', fontSize: 12, color: AXM.bone, marginTop: 3 },
    rollDice: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 18, width: '100%' },
    rollFooter: { paddingBottom: 50, fontFamily: FONTS.mono, fontSize: 9, color: AXM.bone, letterSpacing: 2 },
    ...
    flashStatLabel: { fontFamily: FONTS.sans, fontSize: 9, letterSpacing: 1 },
    flashStatValue: { fontFamily: FONTS.gothic, fontSize: 20, lineHeight: 21 },
    flashStatNeed: { fontFamily: FONTS.mono, fontSize: 11, color: AXM.bone },
    flashCarry: { fontFamily: FONTS.mono, fontSize: 9, letterSpacing: 1, color: HZ.gold, marginTop: 14 },
    ...
    outcomeSub: { fontFamily: FONTS.sans, fontSize: 11, letterSpacing: 2, color: AXM.bone, marginTop: 10 },
