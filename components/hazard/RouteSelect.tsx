...
import type { HazardRouteKey } from '@/state/hazard/types';
...
const styles = StyleSheet.create({
    ...
    topStripSide: { fontFamily: FONTS.mono, fontSize: 8, color: AXM.blood, letterSpacing: 2 },
    ...
    headerEyebrow: { fontFamily: FONTS.sans, fontSize: 10, letterSpacing: 2, color: AXM.blood },
    ...
    handLabel: { fontFamily: FONTS.sans, fontSize: 9, letterSpacing: 1.6, color: AXM.bone, textAlign: 'center', marginTop: 12 },
    ...
    reqChipText: { fontFamily: FONTS.sans, fontSize: 7, letterSpacing: 0.8 },
    routeDesc: { fontFamily: FONTS.serif, fontSize: 12, color: AXM.bone, lineHeight: 16, marginTop: 7 },
    eyebrow: { fontFamily: FONTS.sans, fontSize: 8, letterSpacing: 1.6, color: AXM.bone, marginTop: 10, marginBottom: 4 },
    ladderRow: { flexDirection: 'row', alignItems: 'center', gap: 5 },
    ladderLabel: { flexDirection: 'row', alignItems: 'center', gap: 3, width: 46 },
    ladderLabelText: { fontFamily: FONTS.sans, fontSize: 8, letterSpacing: 0.6 },
    ...
    ladderRound: { fontFamily: FONTS.mono, fontSize: 7, color: AXM.bone },
    ...
    chipValue: { fontFamily: FONTS.serif, fontSize: 11, color: AXM.parchment, flexShrink: 1 },
    chipValueMono: { fontFamily: FONTS.mono, fontSize: 9, color: AXM.parchment },
