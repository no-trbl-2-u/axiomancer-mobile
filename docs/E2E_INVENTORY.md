...
| File | Pattern | Pins | desc | it |
|---|---|---|---:|---:|
| `components/event/__tests__/EncounterModalOverlay.test.tsx` | P4 | Modal-over-map seam: backdrop fade, panel rise, action-button subtitle render, auto-dismiss timing | 3 | 8 |
