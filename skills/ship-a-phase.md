...
`plan/steps/01_build_plan.md` carves Axiomancer Mobile into ~10–20 phases.
...
**Brief:** [\`plan/phases/phase_<N>_<topic>.md\`](https://github.com/no-trbl-2-u/axiomancer-mobile/blob/main/plan/phases/phase_<N>_<topic>.md)
...
Reads via shared loaders (`@axiomancer/content`,
`@axiomancer/data` if applicable); never reach into
...
9. Use the existing AGENTS.md rule set (Hermetic E2E, presenter contract, theme tokens in `theme/axm.ts`)
